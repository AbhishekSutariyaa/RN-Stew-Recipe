...
import {SKEW_LIST} from '../StewData';

const StewListCategory = ({route, navigation}) => {
      ...
      <FlatList
        ...
        renderItem={({item}) => {
          return (
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() => navigation.navigate('StewDetails', {Item: item})}
...
export default StewListCategory;
